...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims, int companyId,string companyName)
        {
            ...
            var jwt = CreateSecurityToken(_tokenOptions, user, signingCredentials, operationClaims, companyId, companyName);
        ...
        public JwtSecurityToken CreateSecurityToken(TokenOptions tokenOptions, User user, SigningCredentials signingCredentials, List<OperationClaim> operationClaims, int companyId, string companyName)
        {
